...
public class ProductController {
    ...
    ResponseEntity<ResponseObject> findById(@PathVariable Long id) {
        ...
        return foundProduct.isPresent() ? ResponseEntity.status(HttpStatus.OK).body(new ResponseObject("ok", "Query product successfully", foundProduct)) : ResponseEntity.status(HttpStatus.NOT_FOUND).body(new ResponseObject("false", "Cannot find product with id = " + id, ""));
    }
    ...
    ResponseEntity<ResponseObject> deleteProduct(@PathVariable Long id) {
        ...
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(new ResponseObject("False", "Cannot find product to delete", ""));
    }
}
